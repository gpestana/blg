...
class EditCategoryForm(Form):
	old_name = TextField('OldName', [Required(message='Category (old) name Required')])
	new_name = TextField('NewName', [Required(message='Category (new) name Required')])

class TagForm(Form):
	name = TextField('Name', [Required(message='Tag name Required')])

class EditTagForm(Form):
	old_name = TextField('OldName', [Required(message='Tag (old) name Required')])
	new_name = TextField('NewName', [Required(message='Tag (new) name Required')])